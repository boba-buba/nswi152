...
namespace ServiceBusReceiver
{
    ...
    {
        private const string connectionString = "Endpoint=sb://mffukservicebus.servicebus.windows.net/;SharedAccessKeyName=all;SharedAccessKey=TtgxZv7ryLN8NGuXpwmtF4E5PQZ397O81+ASbFQE+Dg=;EntityPath=topic"; // ie. Endpoint=sb://xxx.servicebus.windows.net/;SharedAccessKeyName=xxx;SharedAccessKey=xxx
